...
#ifndef FILAMENSAGEM_H
#define FILAMENSAGEM_H
...
public:
  ...
  /**
   * Set the value of mensagens
   * @param new_var the new value of mensagens
   */
  void setMensagens ( Mensagem new_var )   {
      mensagens = new_var;
  }

  /**
   * Get the value of mensagens
   * @return the value of mensagens
   */
   ...
   * @param  mensagem
   */
  void empilhar (Mensagem mensagem )
  {
  }
